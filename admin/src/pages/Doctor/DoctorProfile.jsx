    ...
    profileData && (
      <div
        ...
        <div className="w-full max-w-2xl bg-white shadow-2xl rounded-2xl overflow-hidden border border-gray-100">
          <div className="relative bg-gradient-to-r from-teal-600/5 to-transparent p-6 pb-12 md:pb-6 flex flex-col md:flex-row items-center md:items-end gap-6">
          ...
          <div className="p-6 space-y-6">
            <section>
              <h3 className="flex items-center gap-2 text-gray-800 font-bold mb-2 text-sm">
                <span className="w-1 h-4 bg-teal-600 rounded-full"></span> نبذة
                تعريفية
              </h3>
              {isEdit ? (
                <textarea
                  className="w-full bg-white border border-gray-300 rounded-lg p-3 text-xs leading-relaxed outline-none focus:border-teal-600 transition-all resize-none"
                  rows={4}
            ...
            <section className="bg-slate-50 p-4 rounded-xl border border-gray-100">
              <h3 className="flex items-center gap-2 text-gray-800 font-bold mb-3 text-sm">
                <span className="w-1 h-4 bg-teal-600 rounded-full"></span> جدول
                المواعيد
              </h3>
              <div className="mb-5">
                  ...
                  {daysOfWeek.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={!isEdit}
                        className={`flex-1 min-w-[60px] py-1.5 rounded-lg text-[11px] font-medium transition-all ${isSelected ? "bg-teal-600 text-white" : "bg-white text-gray-400 border border-gray-200"}`}>
                        {day}
                      </button>
                    );
                  })}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-white p-2.5 rounded-lg border border-gray-100 flex flex-col gap-1">
                  ...
                  {isEdit ? (
                    <select
                      className="text-xs font-bold text-teal-600 outline-none bg-transparent"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <section className="space-y-3">
                ...
                <input
                  disabled={!isEdit}
                  className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-xs outline-none focus:border-teal-600 disabled:bg-gray-50"
                  type="text"
                  placeholder="العنوان"
              ...
              <section className="space-y-3">
                <h3 className="text-gray-800 font-bold text-sm flex items-center gap-2">
                  <span className="w-1 h-3 bg-teal-600 rounded-full"></span> سعر
                  الكشف
                </h3>
            ...
            {isEdit && (
              <section className="mt-6 p-4 bg-orange-50/50 rounded-xl border border-orange-100 border-dashed">
                <h3 className="text-orange-800 font-bold text-sm flex items-center gap-2 mb-4">
                  <span className="w-1 h-3 bg-orange-500 rounded-full"></span>{" "}
                  إعدادات الأمان
                </h3>
                <div className="space-y-4">
                  <div>
                    <label className="text-[10px] text-gray-500 mr-2 font-bold">
                      كلمة المرور الحالية
                    </label>
                    <input
                      type="password"
                      className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-xs outline-none focus:border-orange-300"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        type="password"
                        className={`w-full bg-white border rounded-lg px-3 py-2 text-xs outline-none focus:border-orange-300 ${confirmPassword && newPassword !== confirmPassword ? "border-red-400" : "border-gray-200"}`}
                        placeholder="تأكيد   "
                ...
                <p className="text-[9px] text-orange-600 mt-2 mr-2">
                  * اترك الحقول فارغة في حال لم ترغب بتغيير كلمة المرور
                </p>
              </section>
            )}
          </div>
          ...
          <div className="p-4 bg-gray-50 flex justify-center border-t border-gray-100">
            <button
              ...
              className={`px-8 py-2.5 rounded-full font-bold text-sm shadow-md transition-all active:scale-95 ${isEdit ? "bg-orange-600 hover:bg-orange-700" : "bg-teal-600 hover:bg-teal-700"} text-white`}>
